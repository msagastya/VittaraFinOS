...
class FuturesOptions {
  ...
  static OptionsGreeks calculateGreeks({
    ...
    final double d1 =
        (math.log(spotPrice / strikePrice) + (r + 0.5 * sigma * sigma) * t) /
            (sigma * math.sqrt(t));
    ...
    double cumulativeNormal(double x) {
      ...
      if (x >= 0) {
        return 1 - 0.39894228 * math.exp(-0.5 * x * x) * k * a;
      } else {
    ...
    final double nD1 = cumulativeNormal(-d1);
    final double nD2 = cumulativeNormal(-d2);
