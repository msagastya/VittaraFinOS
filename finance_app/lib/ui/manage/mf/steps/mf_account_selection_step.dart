...
class MFAccountSelectionStep extends StatefulWidget {
  const MFAccountSelectionStep({super.key});

  @override
  State<MFAccountSelectionStep> createState() => _MFAccountSelectionStepState();
}

class _MFAccountSelectionStepState extends State<MFAccountSelectionStep> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final wizardController = Provider.of<MFWizardController>(context);

    return Consumer<AccountsController>(
      builder: (context, accountsController, child) {
        // Filter for Investment accounts (where mutual funds are held)
            ...
            Padding(
              ...
              child: CupertinoButton(
                ...
                onPressed: () {
                  ...
                  final wizardCtrl =
                      Provider.of<MFWizardController>(context, listen: false);
