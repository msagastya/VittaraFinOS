...
class StockReviewStep extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
           ...
           _buildRow(context, 'Price per Share', '₹${controller.price.toStringAsFixed(2)}'),
           ...
           _buildRow(context, 'Total Amount', '₹${controller.totalAmount.toStringAsFixed(2)}', isBold: true),
           
           if (controller.deductFromAccount) ...[
             const SizedBox(height: 8),
             _buildRow(context, 'Deducted from Balance', 'Yes', color: Colors.orange),
             if (controller.extraCharges > 0)
               _buildRow(context, 'Extra Charges', '₹${controller.extraCharges.toStringAsFixed(2)}'),
             const SizedBox(height: 8),
             _buildRow(
               context, 
               'Total Deducted', 
  ...
  Widget _buildRow(BuildContext context, String label, String value, {bool isBold = false, Color? color}) {
    return Padding(
