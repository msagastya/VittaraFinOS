                              ...
                              child: CupertinoButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (target == null || target <= 0) {
                                    AlertService.showError(
                                        context, 'Please enter a valid target');
                                    return;
                                  }
                                  final planner = SavingsPlanner(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: Spacing.sm),
                    Text('Create Your First Planner',
                        style: TextStyle(
                            fontSize: TypeScale.callout,
                            fontWeight: FontWeight.w600,
                            color: Colors.white)),
